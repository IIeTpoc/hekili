...
spec:RegisterAbilities( {
    ...
    between_the_eyes = {
        ...
        usable = function()
            if ( settings.crackshot_lock and talent.crackshot.enabled and not stealthed.all ) or ( settings.stealth_lock and talent.crackshot.enabled and buff.stealth.up and not buff.vanish.up ) then return false, "userpref requires stealth" end
